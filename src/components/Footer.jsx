...
const Footer = () => {
  return (
    <div>
      <footer className="text-gray-600 bg-slate-300 shadow-xl body-font">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <Link to='/grocery' className="text-xl underline">Grocery</Link>
          <div className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            ...
            <p>Made with ❤️ by Prateek Pradhan</p>
          </div>
